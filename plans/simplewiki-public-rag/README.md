...
| **AST-Based Code Chunking** | Plan 016 | ✅ **Done** | Syntax-aware atomic chunking for Python (`ast`) and polyglot codebases (`.rs`, `.ts`, `.go`, `.cpp`) with function/class breadcrumbs. |

---

## 3. Active Next Priorities

1. **Continuous Expansion & Evaluation**: Benchmarking retrieval accuracy across mixed-format local vaults, multi-file codebases, and web content.
